...
class GridDragDropState internal constructor(
        ...
        if (draggingItemIndex != null) {
            ...
            scope.launch {
                ...
                previousItemOffset.animateTo(
                    Offset.Zero, spring(
                        stiffness = Spring.StiffnessMediumLow, visibilityThreshold = Offset.VisibilityThreshold
                    )
                )
    ...
    internal fun onDrag(offset: Offset) {
        ...
        if (targetItem != null) {
             ...
             */
            val overscroll = when {
                draggingItemDraggedDelta.y > 0 -> (endOffset.y - state.layoutInfo.viewportEndOffset).coerceAtLeast(0f)

                draggingItemDraggedDelta.y < 0 -> (startOffset.y - state.layoutInfo.viewportStartOffset).coerceAtMost(0f)
